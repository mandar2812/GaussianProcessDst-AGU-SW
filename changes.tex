...
%DIF ADD revised-draft.tex   Tue May 30 15:36:41 2017
...
From the validation results, we can chose the model order which yields the best performance, for GP-AR it is $p_t = 6$ while for GP-ARX it is $p_t = 11$. Further examination of the validation results shows that in the scheme $p_t = 11$ choosing \DIFdelbegin \DIFdel{$p = 7, p_v = 1, p_b = 3$ }\DIFdelend \DIFaddbegin \DIFadd{$p = 6, p_v = 1, p_b = 3$ }\DIFaddend gives superior results.
...
\begin{figure}
\noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{PredictionsModel1/PredErrBars_Storm8.png}
%DIFDELCMD < %%%
...
\begin{figure}
\noindent\DIFdelbeginFL %DIFDELCMD < \includegraphics[width=\textwidth]{PredictionsModel1/PredErrBars_Storm9.png}
%DIFDELCMD < %%%
