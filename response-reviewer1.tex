...
\textbf{Response}: We do not agree with this assertion. To further elaborate the advantage of generating error bars using the Gaussian Process approach we have made changes in lines 91-97 in the file \texttt{changes.pdf}
