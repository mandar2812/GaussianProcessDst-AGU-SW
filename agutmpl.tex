...
For measuring performance of model instances on the validation set storm events, the \emph{mean absolute error} (MAE), \emph{root mean square error} (RMSE) and \emph{coefficient of correlation} (CC) are calculated.
